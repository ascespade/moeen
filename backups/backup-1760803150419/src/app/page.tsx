...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--brand-surface)]">
        ...
        <div className="container-app py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href={ROUTES.LOGIN} className="btn btn-outline text-sm px-6 py-3">
                دخول
              </Link>
              <Link href={ROUTES.REGISTER} className="btn btn-brand text-sm px-6 py-3">
                تسجيل
              </Link>
            </div>
          </div>
      ...
      <section id="services" className="section-gradient-1 py-24">
        <div className="container-app">
          <div className="mb-20 text-center">
            <h2 className="page-header animate-fadeInUp">
              خدماتنا المتخصصة
            </h2>
      ...
      <section
        id="about"
        className="hero-gradient py-24"
      >
        <div className="container-modern">
          <div className="grid-modern-2">
            <div className="animate-slideInLeft">
              <h2 className="page-header text-gradient">
                مركز الهمم
              </h2>
      ...
      <section id="features" className="section-modern bg-white dark:bg-gray-900">
        <div className="container-modern">
