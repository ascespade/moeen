...
class ModuleTestingSystem {
  constructor() {
    this.modules = [
      { name: 'auth', path: 'src/app/(auth)', tests: 'tests/e2e/login-full-test.spec.ts' },
      { name: 'appointments', path: 'src/app/(dashboard)/appointments', tests: 'tests/e2e/appointments.spec.ts' },
      { name: 'patients', path: 'src/app/(dashboard)/patients', tests: 'tests/e2e/patients.spec.ts' },
      { name: 'doctors', path: 'src/app/(dashboard)/doctors', tests: 'tests/e2e/doctors.spec.ts' },
      { name: 'staff', path: 'src/app/(dashboard)/staff', tests: 'tests/e2e/staff.spec.ts' },
      { name: 'insurance', path: 'src/app/(dashboard)/insurance', tests: 'tests/e2e/insurance.spec.ts' },
      { name: 'payments', path: 'src/app/(dashboard)/payments', tests: 'tests/e2e/payments.spec.ts' },
      { name: 'medical-records', path: 'src/app/(dashboard)/medical-records', tests: 'tests/e2e/medical-records.spec.ts' },
      { name: 'chatbot', path: 'src/app/(dashboard)/chatbot', tests: 'tests/e2e/chatbot.spec.ts' },
      { name: 'analytics', path: 'src/app/(dashboard)/analytics', tests: 'tests/e2e/analytics.spec.ts' },
      { name: 'settings', path: 'src/app/(dashboard)/settings', tests: 'tests/e2e/settings.spec.ts' },
