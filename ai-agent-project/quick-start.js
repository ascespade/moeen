...
const message = boxen(
  chalk.green('🚀 AI Agent Project - Quick Start\n\n') +
    ...
    chalk.gray(' - تشغيل الأجنت\n') +
    chalk.white('2. ') +
    chalk.cyan('npm run dev') +
    chalk.gray(' - تشغيل في وضع التطوير\n') +
    chalk.white('3. ') +
    chalk.cyan('npm test') +
    chalk.gray(' - تشغيل الاختبارات\n') +
    chalk.white('4. ') +
    chalk.cyan('node start.js') +
    chalk.gray(' - تشغيل مباشر\n\n') +
    chalk.yellow('💡 نصائح:\n') +
    chalk.gray('• تأكد من تثبيت التبعيات أولاً: ') +
    chalk.white('npm install\n') +
    chalk.gray('• يمكنك تخصيص الإعدادات في: ') +
    chalk.white('config/agent-config.json\n') +
    chalk.gray('• السجلات ستكون في: ') +
    chalk.white('logs/agent.log\n') +
    chalk.gray('• التقارير ستكون في: ') +
