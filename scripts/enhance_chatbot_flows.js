...
const professionalFlows = [
  {
    name: 'حجز_موعد_جديد',
    description: 'Professional appointment booking flow with validation and confirmation',
    status: 'published',
    nodes: [
      {
        node_type: 'start',
        name: 'welcome',
        config: {
          message: 'مرحباً! أنا معين، مساعد مركز الهمم. سأساعدك في حجز موعد جديد.',
          buttons: [
      ...
      },
      {
        ...
        config: {
          message: 'ممتاز! أولاً، أحتاج بعض المعلومات الأساسية:\n\n• الاسم الكامل\n• رقم الهاتف\n• تاريخ الميلاد\n• نوع الخدمة المطلوبة',
          input_type: 'form',
          fields: [
            ...
            { name: 'service_type', label: 'نوع الخدمة', type: 'select', options: ['استشارة نفسية', 'تأهيل نطق', 'تقويم سلوكي'], required: true }
          ]
        },
        position_x: 100,
        position_y: 250
      },
      {
        ...
        config: {
          ...
          validation_rules: {
            phone: { pattern: '^\\+966[0-9]{9}$', message: 'رقم الهاتف غير صحيح' },
            birth_date: { min_age: 3, max_age: 18, message: 'العمر يجب أن يكون بين 3-18 سنة' }
          }
        },
        position_x: 100,
        position_y: 400
  ...
  },
  {
    ...
    description: 'Professional appointment inquiry flow with detailed information',
    status: 'published',
    nodes: [
      {
        node_type: 'start',
      ...
      },
      {
        ...
        config: {
          ...
          fallback_message: 'لم أتمكن من العثور على موعدك. يرجى التأكد من رقم الهاتف أو رقم الموعد.'
        },
        position_x: 300,
        position_y: 250
      },
    ...
    nodes: [
      {
        ...
        config: {
          message: 'مرحباً! أنا معين، مساعد مركز الهمم. كيف يمكنني مساعدتك اليوم؟',
          buttons: [
...
const professionalTemplates = [
  {
    ...
    category: 'greeting',
    language: 'ar',
    content: 'مرحباً وسهلاً! أنا معين، المساعد الذكي لمركز الهمم. أنا هنا لمساعدتك في:\n\n• حجز المواعيد\n• الاستعلام عن الخدمات\n• الإجابة على استفساراتك\n\nكيف يمكنني مساعدتك اليوم؟',
    variables: {}
  },
  {
...
const enhancedTrainingData = [
  ...
  { input_text: 'أريد حجز موعد', expected_output: 'trigger:حجز_موعد_جديد', category: 'intent', tags: ['booking', 'appointment'], confidence_score: 0.95, is_verified: true },
  { input_text: 'ابغى احجز موعد جديد', expected_output: 'trigger:حجز_موعد_جديد', category: 'intent', tags: ['booking', 'appointment'], confidence_score: 0.92, is_verified: true },
  { input_text: 'عندي طفل محتاج استشارة', expected_output: 'trigger:حجز_موعد_جديد', category: 'intent', tags: ['booking', 'consultation'], confidence_score: 0.88, is_verified: true },
  { input_text: 'ممكن احجز مع دكتور نفسي', expected_output: 'trigger:حجز_موعد_جديد', category: 'intent', tags: ['booking', 'psychology'], confidence_score: 0.90, is_verified: true },
  
  // Appointment inquiry intents
  { input_text: 'متى موعدي القادم', expected_output: 'trigger:استعلام_عن_موعد', category: 'intent', tags: ['inquiry', 'appointment'], confidence_score: 0.93, is_verified: true },
  { input_text: 'عندي موعد متى', expected_output: 'trigger:استعلام_عن_موعد', category: 'intent', tags: ['inquiry', 'appointment'], confidence_score: 0.89, is_verified: true },
  { input_text: 'ابغى أعرف مواعيدي', expected_output: 'trigger:استعلام_عن_موعد', category: 'intent', tags: ['inquiry', 'appointment'], confidence_score: 0.91, is_verified: true },
  
  // Cancellation intents
  { input_text: 'أريد إلغاء الموعد', expected_output: 'trigger:الغاء_موعد', category: 'intent', tags: ['cancel', 'appointment'], confidence_score: 0.94, is_verified: true },
  { input_text: 'ابغى ألغي موعدي', expected_output: 'trigger:الغاء_موعد', category: 'intent', tags: ['cancel', 'appointment'], confidence_score: 0.92, is_verified: true },
  { input_text: 'ممكن ألغي الموعد', expected_output: 'trigger:الغاء_موعد', category: 'intent', tags: ['cancel', 'appointment'], confidence_score: 0.90, is_verified: true },
  
  // General inquiries
  { input_text: 'معلومات عن المركز', expected_output: 'trigger:استفسارات_عامة', category: 'intent', tags: ['info', 'center'], confidence_score: 0.87, is_verified: true },
  { input_text: 'وش الخدمات المتاحة', expected_output: 'trigger:استفسارات_عامة', category: 'intent', tags: ['info', 'services'], confidence_score: 0.89, is_verified: true },
  { input_text: 'كم الرسوم', expected_output: 'trigger:استفسارات_عامة', category: 'intent', tags: ['info', 'pricing'], confidence_score: 0.85, is_verified: true }
];
  ...
  try {
    ...
    for (const template of professionalTemplates) {
      ...
      if (existingTemplate) {
        ...
        await update('chatbot_templates', {
    ...
    for (const trainingItem of enhancedTrainingData) {
      ...
      if (!existingTraining) {
        ...
        console.log(`✅ Added training data: ${trainingItem.input_text.substring(0, 30)}...`);
      }
    }
    ...
    console.log('🎉 Professional chatbot flow enhancement completed successfully!');
    console.log('\n📊 Summary:');
    console.log(`• ${professionalFlows.length} professional flows created/updated`);
    console.log(`• ${professionalTemplates.length} professional templates created/updated`);
    console.log(`• ${enhancedTrainingData.length} enhanced training data entries`);
