...
export const __getApiConfig = (): ApiConfig => {
  const whatsappToken =
...
export const __isWhatsAppConfigured = (_cfg: ApiConfig = getApiConfig()) =>
  Boolean(cfg.whatsapp.token && cfg.whatsapp.phoneNumberId);

export const __isAIConfigured = (_cfg: ApiConfig = getApiConfig()) =>
