...
import { _SystemConfig } from "../types";
...
export const __DATABASE_CONFIG = {
...
export const __SUPABASE_CONFIG = {
...
export const __INSURANCE_CONFIG = {
  PROVIDERS: {
    SEHA: {
...
export const __NOTIFICATION_CONFIG = {
  EMAIL: {
  ...
  PUSH: {
    ...
    VAPID_SUBJECT:
      process.env.VAPID_SUBJECT || "mailto:admin@alhemamcenter.com",
  },
...
export const __SECURITY_CONFIG = {
