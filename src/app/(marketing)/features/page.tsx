...
const features = [
  {
    ...
    description: "نظام تقويم متطور لإدارة المواعيد والجلسات العلاجية مع تذكيرات تلقائية",
    icon: "📅",
  ...
  },
  {
    ...
    description: "إدارة وتتبع المطالبات التأمينية بسهولة مع دعم جميع شركات التأمين",
    icon: "📋",
      ...
      <div className="bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-secondary)] py-20">
        <div className="container-app text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            اكتشف كيف يمكن لمنصة مُعين أن تحول مركزك الصحي وتجعل إدارة المرضى والمواعيد أسهل وأكثر كفاءة
          </p>
        </div>
      </div>
        ...
        <div className="container-app">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => (
              <Card key={feature.id} className="p-8 text-center group hover:shadow-xl transition-all duration-300">
                <div className={`h-20 w-20 ${feature.bgColor} mx-auto mb-6 flex items-center justify-center rounded-2xl text-4xl transition-transform group-hover:scale-110`}>
                  {feature.icon}
                </div>
