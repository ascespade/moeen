...
const faqs = [
  ...
  },
  {
    ...
    answer: "بياناتك آمنة معنا. يمكنك تصدير جميع بياناتك قبل الإلغاء، وسنحتفظ بها لمدة 30 يوم إضافي.",
  },
  {
    id: 3,
    question: "هل هناك فترة تجريبية مجانية؟",
    answer: "نعم، نقدم فترة تجريبية مجانية لمدة 14 يوم لجميع الخطط المدفوعة بدون الحاجة لبطاقة ائتمان.",
  },
  {
    id: 4,
      ...
      <div className="bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-secondary)] py-20">
        <div className="container-app text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            اختر الخطة المناسبة لمركزك الصحي. جميع الخطط تشمل دعم فني ممتاز وضمان استرداد الأموال
          </p>
        </div>
      </div>
            ...
            {pricingPlans.map((plan) => (
              <Card
                ...
                className={`p-8 relative ${
                  plan.popular
                    ? 'ring-2 ring-[var(--brand-primary)] shadow-xl scale-105'
                    : ''
                }`}
              >
                {plan.popular && (
      ...
      <div className="py-20">
        <div className="container-app text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ابدأ رحلتك مع منصة مُعين اليوم واستمتع بفترة تجريبية مجانية لمدة 14 يوم
          </p>
