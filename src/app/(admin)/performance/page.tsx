        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
          <Card>
            ...
            <CardContent>
              ...
              <p className='text-xs text-muted-foreground'>مؤشرات نشطة</p>
            </CardContent>
          </Card>
                ...
                <TableRow>
                  <TableHead className='w-12'>
                    <input type='checkbox'
                      ...
                      aria-label='تحديد جميع المؤشرات'
                    />
                  </TableHead>
                  ...
                  <TableRow key={metric.id}>
                    <TableCell>
                      <input type='checkbox'
                        ...
                        aria-label={`تحديد مؤشر ${metric.id}`}
                      />
                    </TableCell>
                    <TableCell>
                      <div>
                    ...
                    <TableCell>{getTypeBadge(metric.type)}</TableCell>
                    <TableCell>
                      <div className='text-lg font-bold'>
                        {metric.value} {metric.unit}
                      </div>
                      <div className='text-xs text-muted-foreground'>
                        تحذير: {metric.threshold.warning}
                        {metric.unit}
                      </div>
                    </TableCell>
                    ...
                    <TableCell>
                      <div className='flex items-center gap-2'>
                        ...
                        <span
                          className={`text-sm ${metric.changePercent > 0 ? 'text-red-500' : metric.changePercent < 0 ? 'text-green-500' : 'text-gray-500'}`}
                        >
        ...
        <Dialog open={isMetricDialogOpen} onOpenChange={setIsMetricDialogOpen}>
          <DialogContent className='max-w-2xl'>
            <DialogHeader>
              ...
              <DialogDescription>تفاصيل مؤشر الأداء</DialogDescription>
            </DialogHeader>
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <div className='grid grid-cols-2 gap-4 text-sm'>
                    <div>
                      تحذير: {selectedMetric.threshold.warning}
                      {selectedMetric.unit}
                    </div>
                    <div>
                      حرج: {selectedMetric.threshold.critical}
                      {selectedMetric.unit}
                    </div>
                  </div>
                </div>
