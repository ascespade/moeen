...
const ContactsPage: React.FC = () => {
  ...
  const __getActivityIcon = (_type: string) => {
    switch (type) {
      case "call":
  ...
  const __filteredContacts = contacts.filter((contact) => {
    const matchesSearch =
  ...
  const __contactActivities = selectedContact
    ? activities.filter(
