      ...
      if (result.success) {
        ...
        setTotalPages(
          result.pagination?.pages ||
            Math.ceil(transformedUsers.length / 20) ||
            1
        );
      } else {
              ...
              <div className='space-y-4'>
                ...
                <div>
                  ...
                  <div className='grid grid-cols-2 gap-4 text-sm'>
                    <div>
                      ...
                      {selectedUser.statistics.totalLogins}
                    </div>
                    <div>
                      عدد الجلسات: {selectedUser.statistics.sessionsCount}
                    </div>
                    <div>
                      متوسط مدة الجلسة:{' '}
                      {selectedUser.statistics.averageSessionDuration} دقيقة
                    </div>
                    <div>
                      آخر نشاط:{' '}
                      {formatDate(selectedUser.statistics.lastActivity)}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className='grid grid-cols-2 gap-4 text-sm'>
                    <div>
                      اللغة:{' '}
                      {selectedUser.preferences.language === 'ar'
                        ? 'العربية'
                        : 'English'}
                    </div>
                    <div>
