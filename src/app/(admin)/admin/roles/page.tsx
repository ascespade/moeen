  ...
  useEffect(() => {
    ...
    const mockPermissions: Permission[] = [
      ...
      },
      {
        ...
        displayName: 'حذف المرضى',
        description: 'حذف المرضى',
        category: 'المرضى',
        isSystem: true,
      },
      {
        id: 'patients:view_own',
        name: 'patients:view_own',
        displayName: 'عرض بياناته الشخصية',
        description: 'عرض البيانات الشخصية فقط',
        category: 'المرضى',
        isSystem: true,
      },
      ...
      // Appointments permissions
      {
        ...
        displayName: 'عرض المواعيد',
        description: 'عرض قائمة المواعيد',
        category: 'المواعيد',
        isSystem: true,
      },
      {
      ...
      },
      {
        ...
        displayName: 'تعديل المواعيد',
        description: 'تعديل بيانات المواعيد',
        category: 'المواعيد',
        isSystem: true,
      },
      {
      ...
      },
      {
        ...
        displayName: 'عرض مواعيده',
        description: 'عرض المواعيد الشخصية فقط',
        category: 'المواعيد',
        isSystem: true,
      },
      {
        id: 'appointments:create_own',
        name: 'appointments:create_own',
        displayName: 'إنشاء موعد شخصي',
        description: 'إنشاء موعد شخصي',
        category: 'المواعيد',
        isSystem: true,
      },
      ...
      // Security permissions
      {
        id: 'security:view',
        name: 'security:view',
        displayName: 'عرض الأمان',
        description: 'عرض إعدادات الأمان',
        category: 'الأمان',
        isSystem: true,
      },
      {
        id: 'security:edit',
        name: 'security:edit',
        displayName: 'تعديل الأمان',
        description: 'تعديل إعدادات الأمان',
        category: 'الأمان',
        isSystem: true,
      },
      ...
      },
      {
        ...
        displayName: 'تعديل الإشعارات',
        description: 'تعديل الإشعارات',
        category: 'الإشعارات',
        isSystem: true,
      },
      {
        ...
        displayName: 'حذف الإشعارات',
        description: 'حذف الإشعارات',
        category: 'الإشعارات',
        isSystem: true,
      },
      {
        id: 'notifications:view_own',
        name: 'notifications:view_own',
        displayName: 'عرض إشعاراته',
        description: 'عرض الإشعارات الشخصية فقط',
        category: 'الإشعارات',
        isSystem: true,
      },
      ...
      // Medical records permissions
      {
        ...
        displayName: 'عرض السجلات الطبية',
        description: 'عرض السجلات الطبية',
      ...
      },
      {
        ...
        displayName: 'إنشاء سجل طبي',
        description: 'إنشاء سجل طبي جديد',
        category: 'السجلات الطبية',
        isSystem: true,
      },
      {
        ...
        displayName: 'تعديل السجلات الطبية',
        description: 'تعديل السجلات الطبية',
        category: 'السجلات الطبية',
        isSystem: true,
      },
      {
        id: 'medical_records:view_own',
        name: 'medical_records:view_own',
        displayName: 'عرض سجله الطبي',
        description: 'عرض السجل الطبي الشخصي فقط',
        category: 'السجلات الطبية',
        isSystem: true,
      },
  ...
  const getStatusBadge = (isActive: boolean) => {
    if (isActive) {
      ...
      return (
        <Badge
          variant='outline'
          className='bg-[color-mix(in_srgb,var(--text-muted)_10%,transparent)] text-[var(--text-muted)] border-[color-mix(in_srgb,var(--text-muted)_20%,transparent)]'
        >
          غير نشط
        </Badge>
      );
  ...
  const getSystemBadge = (isSystem: boolean) => {
    if (isSystem) {
      return (
        <Badge
          variant='secondary'
          className='bg-[color-mix(in_srgb,var(--brand-info)_10%,transparent)] text-[var(--brand-info)] border-[color-mix(in_srgb,var(--brand-info)_20%,transparent)]'
        >
          نظام
        </Badge>
      );
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
          <Card>
            ...
            <CardContent>
              ...
              <p className='text-xs text-muted-foreground'>أدوار نشطة ومخصصة</p>
            </CardContent>
          </Card>
        ...
        <Dialog open={isRoleDialogOpen} onOpenChange={setIsRoleDialogOpen}>
          <DialogContent className='max-w-2xl'>
            <DialogHeader>
              ...
              <DialogDescription>تفاصيل الدور والصلاحيات</DialogDescription>
            </DialogHeader>
