    ...
    const mockDoctors: Doctor[] = [
      {
        ...
        education: [
          ...
          'ماجستير طب الأسرة - جامعة الملك عبدالعزيز',
        ],
      ...
      },
      {
        ...
        experience: 12,
        education: [
          'بكالوريوس الطب والجراحة - جامعة الملك عبدالعزيز',
          'ماجستير أمراض القلب - جامعة الملك سعود',
        ],
        certifications: [
          'البورد السعودي لأمراض القلب',
          'شهادة قسطرة القلب التداخلية',
        ],
      ...
      },
      {
        ...
        education: [
          'بكالوريوس الطب والجراحة - جامعة الملك سعود',
          'ماجستير الجراحة العامة - جامعة الملك عبدالعزيز',
        ],
        certifications: [
          'البورد السعودي للجراحة العامة',
      ...
      },
      {
        ...
        education: [
          'بكالوريوس الطب والجراحة - جامعة الملك سعود',
          'ماجستير الطب النفسي - جامعة الملك عبدالعزيز',
        ],
      ...
      <div className='container-app py-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className='text-xs text-muted-foreground'>عبر جميع الأطباء</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>عرض وإدارة جميع أطباء المركز</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
                  ...
                  <TableRow key={doctor.id}>
                    <TableCell>
                      <input
                        ...
                        aria-label={`تحديد طبيب ${doctor.name}`}
                      />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className='text-sm'>{doctor.experience} سنة</div>
                      <div className='text-xs text-muted-foreground'>
