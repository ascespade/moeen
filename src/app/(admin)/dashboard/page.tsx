                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {metrics?.crm.leads.total > 0 
                      ? Math.round((metrics.crm.leads.converted / metrics.crm.leads.total) * 100)
                      : 0}%
                  </div>
                  <p className="text-xs text-muted-foreground">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">{metrics?.automation.socialMedia.totalPosts || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Total Views</span>
                      <span className="font-bold">{metrics?.automation.socialMedia.engagement.totalViews.toLocaleString() || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Total Likes</span>
                      <span className="font-bold">{metrics?.automation.socialMedia.engagement.totalLikes.toLocaleString() || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Total Comments</span>
                      <span className="font-bold">{metrics?.automation.socialMedia.engagement.totalComments.toLocaleString() || 0}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">{metrics?.automation.workflows.totalWorkflows || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Valid Workflows</span>
                      <span className="font-bold text-green-600">{metrics?.automation.workflows.validWorkflows || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Invalid Workflows</span>
                      <span className="font-bold text-red-600">{metrics?.automation.workflows.invalidWorkflows || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Success Rate</span>
                      <span className="font-bold">
                        {metrics?.automation.workflows.totalWorkflows > 0 
                          ? Math.round((metrics.automation.workflows.validWorkflows / metrics.automation.workflows.totalWorkflows) * 100)
                          : 0}%
                      </span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <div className="text-2xl font-bold text-blue-600">
                      {metrics?.automation.socialMedia.engagement.totalViews.toLocaleString() || 0}
                    </div>
                    <div className="text-sm text-blue-700">Total Views</div>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">
                      {metrics?.automation.socialMedia.engagement.totalLikes.toLocaleString() || 0}
                    </div>
                    <div className="text-sm text-green-700">Total Likes</div>
                  </div>
                  <div className="text-center p-4 bg-yellow-50 rounded-lg">
                    <div className="text-2xl font-bold text-yellow-600">
                      {metrics?.automation.socialMedia.engagement.totalComments.toLocaleString() || 0}
                    </div>
                    <div className="text-sm text-yellow-700">Total Comments</div>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">
                      {metrics?.automation.socialMedia.engagement.totalShares.toLocaleString() || 0}
                    </div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-green-50 rounded-lg">
                      ...
                      <div className="text-sm text-green-700">Valid Workflows</div>
                    </div>
                    <div className="text-center p-4 bg-red-50 rounded-lg">
                      <div className="text-2xl font-bold text-red-600">
                        {metrics?.automation.workflows.invalidWorkflows || 0}
                      </div>
                      <div className="text-sm text-red-700">Invalid Workflows</div>
                    </div>
                    <div className="text-center p-4 bg-blue-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">
                        {metrics?.automation.workflows.totalWorkflows || 0}
                  ...
                  {metrics?.automation.workflows.commonIssues && Object.keys(metrics.automation.workflows.commonIssues).length > 0 && (
                    <div>
                      <h4 className="font-medium mb-3">Common Issues</h4>
                      <div className="space-y-2">
                        {Object.entries(metrics.automation.workflows.commonIssues).map(([issue, count]) => (
                          <div key={issue} className="flex justify-between items-center p-2 bg-gray-50 rounded">
