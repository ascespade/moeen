...
export default function AdminLayout({
  ...
  return (
    <UnifiedProtectedRoute allowedRoles={['admin', 'manager', 'supervisor']}>
      <div
        className='flex min-h-dvh bg-background text-foreground overflow-hidden'
        role='application'
      >
        {/* Sidebar - Always visible, sticky */}
        <nav
          className='sticky top-0 h-screen overflow-hidden flex-shrink-0'
          role='navigation'
        ...
        <div className='flex-1 flex flex-col min-w-0 overflow-hidden'>
          ...
          <main
            className='flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto overflow-x-hidden'
            role='main'
