                  ...
                  >
                    ...
                    {isEditing && (
                      <button
                        ...
                        className='text-sm text-primary-error hover:text-red-700'
                      >
                        حذف
                      </button>
                    )}
                ...
                {isEditing && (
                  <div className='flex gap-2'>
                    <input
                      ...
                      className='flex-1 rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-transparent focus:ring-2 focus:ring-[var(--primary-primary)]'
                      onKeyPress={e => {
                        if (e.key === 'Enter') {
                    ...
                    <button
                      ...
                      className='rounded-lg bg-[var(--primary-primary)] px-3 py-2 text-sm text-white transition-colors hover:bg-[var(--primary-primary-hover)]'
                    >
                      إضافة
                    </button>
                  </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className='w-full rounded-lg border border-gray-300 px-3 py-2 font-mono focus:border-transparent focus:ring-2 focus:ring-[var(--primary-primary)]'
