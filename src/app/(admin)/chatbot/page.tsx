...
export default function ChatbotPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'flows' | 'templates' | 'analytics' | 'integrations'
  >('flows');
  ...
  useEffect(() => {
    ...
    const mockTemplates: ChatbotTemplate[] = [
      ...
      },
      {
        ...
        language: 'ar',
        content:
          'تم تأكيد موعدك في {التاريخ} في الساعة {الوقت} مع د. {اسم الطبيب}',
      ...
      },
      {
        ...
        language: 'ar',
        content:
          'نقدم في مركز الهمم: الطب العام، أمراض القلب، الجراحة، طب الأطفال، والطب النفسي',
        variables: [],
        usage: 456,
        rating: 4.5,
        isPublic: true,
      ...
      <div className='container-app py-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
          ...
          <Card>
            ...
            <CardContent>
              <div className='text-2xl font-bold'>
                {analytics?.averageResponseTime} ثانية
              </div>
              <p className='text-xs text-muted-foreground'>
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    التدفقات الأكثر تفاعلاً مع المستخدمين
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    القوالب الأكثر استخداماً في المحادثات
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    نسبة استخدام البوت حسب نوع الجهاز
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='space-y-4'>
                    {analytics.deviceBreakdown.map((device, index) => (
                      ...
                      >
                        <div className='flex items-center gap-3'>
                          {device.device === 'الهاتف المحمول' && (
                            <Smartphone className='h-4 w-4' />
                          )}
                          {device.device === 'الكمبيوتر' && (
                            <Monitor className='h-4 w-4' />
                          )}
                          {device.device === 'التابلت' && (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  عدد المحادثات اليومية خلال آخر 15 يوم
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {analytics.dailyStats.map((stat, index) => (
                    ...
                    >
                      <div
                        ...
                        style={{
                          height: `${(stat.conversations / Math.max(...analytics.dailyStats.map(s => s.conversations))) * 200}px`,
                        }}
                      />
              ...
              <CardHeader>
                <div className='flex justify-between items-center'>
                  <div>
                    ...
                    <CardDescription>
                      {activeTab === 'flows' &&
                        'إدارة تدفقات المحادثة والتفاعل'}
                      {activeTab === 'templates' &&
                        'إدارة قوالب الرسائل والردود'}
                    </CardDescription>
                  </div>
                  <Button>
