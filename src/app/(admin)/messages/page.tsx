    ...
    const mockMessages: Message[] = [
      {
        ...
        content:
          'تم تأكيد موعدك مع د. فاطمة أحمد يوم الأحد الموافق 20 يناير في الساعة 10:00 صباحاً',
        senderId: 'system',
      ...
      },
      {
        ...
        content:
          'تذكير: لديك موعد مع د. نورا الزهراني غداً في الساعة 2:00 مساءً',
        senderId: 'system',
      ...
      },
      {
        ...
        subject: 'استلام دفعة',
        content:
          'تم استلام دفعة بقيمة 500 ريال من المريض محمد عبدالله القحطاني',
        senderId: 'system',
      ...
      },
      {
        ...
        content:
          'احصل على خصم 20% على جميع الخدمات الطبية هذا الأسبوع. لا تفوت الفرصة!',
        senderId: 'marketing1',
  ...
  const folders = [
    {
      ...
      count: messages.filter(m => !m.isDeleted && !m.isArchived && !m.isSpam)
        .length,
    },
    {
      id: 'sent',
      label: 'المرسل',
      icon: <Outbox className='h-4 w-4' />,
      count: messages.filter(m => m.senderId === 'current_user').length,
    },
    {
      id: 'drafts',
      label: 'المسودات',
      icon: <Drafts className='h-4 w-4' />,
      count: messages.filter(m => m.status === 'draft').length,
    },
    {
      id: 'spam',
      label: 'المهمل',
      icon: <Spam className='h-4 w-4' />,
      count: messages.filter(m => m.isSpam).length,
    },
    {
      id: 'trash',
      label: 'المحذوف',
      icon: <Trash className='h-4 w-4' />,
      count: messages.filter(m => m.isDeleted).length,
    },
    {
      id: 'archived',
      label: 'المؤرشف',
      icon: <ArchiveIcon className='h-4 w-4' />,
      count: messages.filter(m => m.isArchived).length,
    },
  ];
                ...
                <div className='space-y-1'>
                  {folders.map(folder => (
                    <button
                      ...
                      aria-label={`فتح مجلد ${folder.label}`}
