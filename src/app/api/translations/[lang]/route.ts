...
async function logMissingTranslationKeys(requestedLang: string, missingKeys: string[]) {
  try {
...
function getDefaultTranslations(lang: string) {
  ...
  return defaultTranslations[lang as keyof typeof defaultTranslations] || defaultTranslations.en;
}
