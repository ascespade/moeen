...
async function __handleAppointmentCreated(
...
async function __handleAppointmentConfirmed(
  appointmentId: string,
  doctorId: string,
  patientId: string,
  supabase: unknown,
...
async function __handleAppointmentCancelled(
  appointmentId: string,
  doctorId: string,
  patientId: string,
  supabase: unknown,
...
async function __handleAppointmentReminder(
  appointmentId: string,
  doctorId: string,
  patientId: string,
  supabase: unknown,
...
async function __handlePatientMessage(
  patientId: string,
  doctorId: string,
  message: string,
  channel: string,
...
async function __handleDoctorResponse(
  patientId: string,
  doctorId: string,
  message: string,
  supabase: unknown,
...
async function __handleEmergencyAlert(
  message: string,
  channel: string,
  priority: string,
) {
