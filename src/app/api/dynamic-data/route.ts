    ...
    const dynamicData = {
      ...
      contact_info: [
        ...
        },
        {
          ...
          value: 'info@alhemam.sa',
          icon: '📧',
          link: 'mailto:info@alhemam.sa',
          color: 'bg-[var(--brand-primary)]',
        },
        {
          id: 3,
          type: 'location',
          title: 'الموقع',
          value: 'جدة، شارع الأمير محمد بن عبدالعزيز (التحلية)، فندق دبليو إيه، الدور الثامن، حي الصفا',
          icon: '📍',
          link: '/contact',
