          ...
          {iep && (
            <div className="text-left">
              <div className={`inline-block px-4 py-2 rounded-full text-sm font-semibold ${
                iep.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'
              }`}>
        ...
        <>
          ...
          <div className="card p-6 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">عدد الأهداف</p>
                <p className="font-semibold text-gray-900 dark:text-white">
                  {goals.length}
                </p>
              </div>
                  ...
                  <div key={goal.id} className="card p-6">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <span className={`text-xs px-2 py-1 rounded-full ${DOMAIN_COLORS[goal.domain] || 'bg-gray-100 text-gray-700'}`}>
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`text-xs px-2 py-1 rounded-full ${
                        ...
                        {goal.status === 'achieved' ? '✅ تم تحقيقه' :
