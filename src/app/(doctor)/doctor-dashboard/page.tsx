          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
            <Card className='p-6'>
              <div className='flex items-center'>
                <Calendar className='h-8 w-8 text-default-default mr-4' />
                <div>
            ...
            <Card className='p-6'>
              <div className='flex items-center'>
                <Users className='h-8 w-8 text-default-success mr-4' />
                <div>
                  <p className='text-sm text-gray-600 dark:text-gray-400'>
            ...
            <Card className='p-6'>
              <div className='flex items-center'>
                <Clock className='h-8 w-8 text-default-default mr-4' />
                <div>
                  <p className='text-sm text-gray-600 dark:text-gray-400'>
                        ...
                        <div className='flex items-center'>
                          <div className='flex-shrink-0'>
                            <div className='w-10 h-10 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center'>
                              <Stethoscope className='h-5 w-5 text-default-default' />
                            </div>
                          </div>
                          <div className='ml-4'>
