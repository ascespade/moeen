          ...
          <div className='grid gap-6'>
            ...
            <section className='card p-6'>
              ...
              <div className='flex flex-wrap gap-2'>
                <button className='btn btn-default' aria-label='Primary'>
                  Primary
                </button>
                <button className='btn btn-info' aria-label='Secondary'>
                  Secondary
                </button>
                <button className='btn btn-outline' aria-label='Ghost'>
                  Ghost
                </button>
                <button
