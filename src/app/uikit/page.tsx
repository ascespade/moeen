      ...
      <div className="container-app py-6">
        <div className="grid gap-6">
          ...
          <section className="card p-6">
            <div className="font-medium text-[var(--foreground)] mb-3">Buttons</div>
          ...
          <section className="card p-6">
            <div className="font-medium text-[var(--foreground)] mb-3">Inputs</div>
          ...
          <section className="card p-6">
            <div className="font-medium text-[var(--foreground)] mb-3">Cards & Badges</div>
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="card p-4">
                <div className="text-sm text-[var(--foreground)]/60">عنوان</div>
                <div className="text-lg font-semibold text-[var(--foreground)]">بطاقة بعناصر
                  <span className="ms-2 badge badge-accent">Accent</span>
                </div>
              </div>
              <div className="card p-4">
                <div className="text-sm text-[var(--foreground)]/60">عنوان</div>
                <div className="text-lg font-semibold text-[var(--foreground)]">بطاقة أخرى</div>
              </div>
            </div>
          </section>
        </div>
