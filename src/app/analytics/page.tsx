    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-white/70">Deep insights into test performance and system health</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <select
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/70 text-sm font-medium">Test Efficiency</p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/70 text-sm font-medium">Avg Response Time</p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/70 text-sm font-medium">Auto-Fixes Applied</p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/70 text-sm font-medium">System Health</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-6">Test Performance Over Time</h3>
            <div className="space-y-4">
              {performanceData.map((day, index) => (
                <div key={day.name} className="flex items-center space-x-4">
                  <div className="w-12 text-white/70 font-medium">{day.name}</div>
                  ...
                  <div className="w-20 text-right">
                    <div className="text-green-400 text-sm font-semibold">{day.passed}</div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-6">Test Type Distribution</h3>
            <div className="space-y-4">
              {testTypes.map((type, index) => (
                <div key={type.name} className="flex items-center space-x-4">
                  <div className="w-32 text-white/70 font-medium">{type.name}</div>
                  <div className="flex-1 bg-white/10 rounded-full h-3 relative">
                    <div
                  ...
                  <div className="w-20 text-right">
                    <div className="text-white text-sm font-semibold">{type.success}/{type.count}</div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 mb-8">
          <h3 className="text-xl font-semibold text-white mb-6">Module Performance Analysis</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {modulePerformance.map((module) => (
              ...
              >
                <h4 className="font-semibold text-white capitalize mb-4">{module.name}</h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-6">Recent Test Runs</h3>
            <div className="space-y-4">
              {[
                { time: '2 minutes ago', module: 'app', status: 'passed', duration: '1.2s' },
                { time: '5 minutes ago', module: 'components', status: 'failed', duration: '2.1s' },
                { time: '8 minutes ago', module: 'config', status: 'passed', duration: '0.9s' },
                { time: '12 minutes ago', module: 'constants', status: 'passed', duration: '1.5s' },
                { time: '15 minutes ago', module: 'context', status: 'passed', duration: '1.8s' }
              ].map((run, index) => (
                <div key={index} className="flex items-center space-x-4 p-3 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    <div className="text-white font-medium capitalize">{run.module}</div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
            ...
            <div className="space-y-4">
              {[
                { type: 'warning', message: 'High memory usage detected in app module', time: '5 min ago' },
                { type: 'info', message: 'Auto-fix applied to components module', time: '12 min ago' },
                { type: 'success', message: 'All tests passed for constants module', time: '18 min ago' },
                { type: 'warning', message: 'Slow response time in config module', time: '25 min ago' },
                { type: 'info', message: 'Database connection optimized', time: '32 min ago' }
              ].map((alert, index) => (
                <div key={index} className="flex items-start space-x-3 p-3 bg-white/5 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-white/50 text-xs mt-1">{alert.time}</div>
                  </div>
                </div>
              ))}
            </div>
