          ...
          <div className="flex min-h-screen items-center justify-center bg-[var(--brand-surface)] p-4">
            <div className="card w-full max-w-md p-8 text-center">
              ...
              <p className="mb-6 text-gray-600 dark:text-gray-300">
                تم إرسال رابط إعادة تعيين كلمة المرور إلى بريدك الإلكتروني. تحقق
                من صندوق الوارد أو مجلد الرسائل المزعجة.
              </p>
            ...
            <div className="w-full max-w-md">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-500">
                  إذا لم تستلم البريد الإلكتروني، تحقق من مجلد الرسائل المزعجة
                  أو{" "}
                  <button
                    onClick={() => {
                      setEmail("");
