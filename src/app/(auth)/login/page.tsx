...
export default function LoginPage() {
  ...
  return (
    <div
      className='flex min-h-screen items-center justify-center bg-gradient-to-br from-[var(--default-surface)] via-white to-[var(--bg-gray-50)] p-4'
      role='application'
    >
      {/* Skip Link */}
      <a
      ...
      <main id='main-content' className='w-full max-w-md' role='main'>
        <header className='mb-8 text-center' role='banner'>
          <div
            className='mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-r from-[var(--default-default)] to-[var(--default-info)] shadow-lg'
            role='img'
        ...
        >
          <div className='p-8'>
            {error && (
              <div
                className='status-error mb-6 p-4'
                role='alert'
                aria-live='assertive'
              >
            ...
            <section
              className='border-default mt-6 border-t pt-6'
              aria-labelledby='quick-login-heading'
            >
              <h2
                id='quick-login-heading'
                className='mb-4 text-center text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400'
              >
              ...
              <div
                ...
                role='group'
                aria-label='أزرار تسجيل الدخول السريع'
              >
                <button
                  type='button'
                  onClick={() =>
              ...
              <div
                className='mt-3 p-3 bg-[var(--panel)] rounded-lg border border-[var(--brand-border)]'
                role='region'
                aria-label='بيانات الاختبار'
              >
