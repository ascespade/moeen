    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-3">
          <nav className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Image src="/logo.jpg" alt="Hemam Logo" width={36} height={36} className="rounded" priority unoptimized />
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-screen-xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Image src="/logo.jpg" alt="Hemam Logo" width={28} height={28} className="rounded" unoptimized />
