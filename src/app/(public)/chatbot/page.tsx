...
const HealthcareChatbot: React.FC = () => {
    ...
    return (
      <div className='fixed bottom-4 right-4 z-50'>
        <Button
          ...
          className='h-14 w-14 rounded-full bg-gradient-to-r from-[var(--default-default)] to-[var(--default-info)] shadow-lg hover:shadow-xl'
        >
  ...
  return (
    <div className='fixed bottom-4 right-4 z-50 w-96 h-[600px] bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden'>
      {/* Header */}
      <div className='bg-gradient-to-r from-[var(--default-default)] to-[var(--default-info)] p-4 text-white'>
