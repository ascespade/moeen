...
export default function SettingsPage() {
        ...
        <div className='space-y-4'>
          ...
          <div>
            ...
            <p className='text-white/70 text-sm mb-2'>
              Number of parallel test workers (1-8)
            </p>
            <input
              type='range'
              min='1'
              ...
              onChange={e =>
                handleSettingChange('parallelWorkers', parseInt(e.target.value))
              }
          ...
          <div>
            ...
            <p className='text-white/70 text-sm mb-2'>
              Maximum time for each test to complete
            </p>
            <input
              type='number'
              min='10'
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                handleSettingChange('retries', parseInt(e.target.value))
              }
              className='w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500'
            />
          </div>
    ...
    <div className='space-y-6'>
      <div className='bg-white/5 rounded-xl p-6'>
        ...
        <div className='space-y-4'>
          {[
            {
              key: 'playwrightEnabled',
              name: 'Playwright UI Tests',
              description: 'User interface and interaction testing',
            },
            {
              key: 'supawrightEnabled',
              name: 'Supawright DB Tests',
              description: 'Database and API testing',
            },
            {
            ...
            <div key={test.key} className='flex items-center justify-between'>
              ...
              <label className='relative inline-flex items-center cursor-pointer'>
                <input
                  type='checkbox'
                  checked={
                    settings[test.key as keyof typeof settings] as boolean
                  }
                  onChange={e =>
                    handleSettingChange(test.key, e.target.checked)
                  }
                  className='sr-only peer'
                />
                <div className="w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
            ...
            <div key={fix.key} className='flex items-center justify-between'>
              ...
              <label className='relative inline-flex items-center cursor-pointer'>
                <input
                  type='checkbox'
                  checked={
                    settings[fix.key as keyof typeof settings] as boolean
                  }
        ...
        <div className='space-y-6'>
          <div>
            ...
            <input
              ...
              onChange={e =>
                handleSettingChange('maxMemoryUsage', parseInt(e.target.value))
              }
              className='w-full h-2 bg-gray-600 rounded-lg appearance-none cursor-pointer'
            />
            <div className='flex justify-between text-white/70 text-sm mt-1'>
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                handleSettingChange('cpuThreshold', parseInt(e.target.value))
              }
              className='w-full h-2 bg-gray-600 rounded-lg appearance-none cursor-pointer'
            />
            <div className='flex justify-between text-white/70 text-sm mt-1'>
          ...
          <div>
            ...
            <p className='text-white/70 text-sm mb-2'>
              Alert when disk space usage exceeds this threshold
            </p>
            <input
              type='range'
              min='50'
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'tests':
        return renderTestSettings();
      case 'autofix':
        return renderAutoFixSettings();
      case 'performance':
            ...
            <div className='flex items-center space-x-4'>
              ...
              <div>
                ...
                <p className='text-white/70'>
                  Configure your Ultimate E2E Self-Healing Runner
                </p>
              </div>
            </div>
            <div className='flex items-center space-x-4'>
