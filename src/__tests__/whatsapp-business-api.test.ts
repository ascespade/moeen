...
describe('WhatsAppBusinessAPI', () => {
  ...
  describe('Text Messages', () => {
    test('should send text message successfully', async () => {
      ...
      const result = await whatsappAPI.sendTextMessage('+966501234567', 'مرحبا');
  ...
  describe('Template Messages', () => {
    test('should send template message successfully', async () => {
      ...
      const result = await whatsappAPI.sendTemplateMessage('+966501234567', 'appointment_confirmation', 'ar', ['أحمد', '2024-01-20', '10:00']);
    ...
    test('should handle template message failure', async () => {
      ...
      const result = await whatsappAPI.sendTemplateMessage('+966501234567', 'invalid_template', 'ar');
  ...
  describe('Media Messages', () => {
    test('should send image message successfully', async () => {
      ...
      const result = await whatsappAPI.sendImageMessage('+966501234567', 'https://example.com/image.jpg', 'صورة توضيحية');
    ...
    test('should send document message successfully', async () => {
      ...
      const result = await whatsappAPI.sendDocumentMessage('+966501234567', 'https://example.com/doc.pdf', 'document.pdf', 'مستند مهم');
  ...
  describe('Webhook Verification', () => {
    test('should verify webhook with correct token', () => {
      ...
      const result = whatsappAPI.verifyWebhook('subscribe', 'test_token', 'challenge_123');
    ...
    test('should reject webhook with incorrect token', () => {
      ...
      const result = whatsappAPI.verifyWebhook('subscribe', 'wrong_token', 'challenge_123');
