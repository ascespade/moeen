...
describe('RegisterPage', () => {
  ...
  it('validates form fields correctly', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('يجب الموافقة على الشروط والأحكام')).toBeInTheDocument();
    });
  });
  ...
  it('shows success message after successful registration', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('مرحباً بك في مُعين. يمكنك الآن تسجيل الدخول باستخدام بياناتك.')).toBeInTheDocument();
    });
  });
