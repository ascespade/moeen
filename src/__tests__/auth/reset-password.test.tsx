...
describe('ResetPasswordPage', () => {
  ...
  it('shows success message after successful reset', async() => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('تم تغيير كلمة المرور بنجاح. يمكنك الآن تسجيل الدخول باستخدام كلمة المرور الجديدة.')).toBeInTheDocument();
    });
  });
  ...
  it('shows password requirements', () => {
    ...
    expect(screen.getByText('• تجنب استخدام كلمات مرور سهلة التخمين')).toBeInTheDocument();
  });
