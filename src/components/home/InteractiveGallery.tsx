...
const galleryImages = [
  ...
  },
  {
    id: 3,
    src: '/gallery-3.jpg',
    title: 'عيادة النطق والسمع',
    category: 'النطق والسمع',
  },
  ...
  return (
    ...
    >
      ...
      {selectedImage && (
        ...
        >
          <button onClick={() => { setSelectedImage(null)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); () aria-label="Button" setSelectedImage(null) } }}
