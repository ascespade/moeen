        ...
        <div className="h-14 grid grid-cols-[auto_1fr_auto] items-center gap-3">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="w-full max-w-[680px] ms-auto lg:ms-0">
              <div className="relative">
                <input 
                  type="search" 
                  className="py-2 pe-10 ps-3 block w-full border border-gray-200 dark:border-gray-700 rounded-md text-sm text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-900 focus:ring-1 focus:ring-blue-500" 
          ...
          <div className="flex items-center gap-2 justify-self-end">
            <div className="hs-dropdown relative inline-flex">
              <button 
                className="h-9 rounded-md border border-gray-200 dark:border-gray-700 px-3 inline-flex items-center gap-2 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" 
                aria-haspopup="menu"
              >
                {theme === "light" ? "☀️" : "🌙"}
            ...
            <button 
              className="h-9 rounded-md border border-gray-200 dark:border-gray-700 px-3 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" 
            ...
            <div className="hs-dropdown [--trigger:hover] relative inline-flex">
              <button className="relative h-9 w-9 rounded-full border border-gray-200 dark:border-gray-700 grid place-items-center text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500" aria-haspopup="menu" aria-expanded="false">
                🔔
                {notif > 0 && (
            ...
            <div className="hs-dropdown relative inline-flex">
              <button className="h-9 w-9 rounded-full bg-gray-200 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500" aria-haspopup="menu" aria-expanded="false" />
