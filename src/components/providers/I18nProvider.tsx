...
export function I18nProvider({ locale: localeProp, ns = "common", children }: { locale?: "ar" | "en"; ns?: string; children: React.ReactNode }) {
  const [resolvedLocale, setResolvedLocale] = useState<"ar" | "en">(localeProp || "ar");
  useEffect(() => {
  ...
  const value = useMemo(() => ({ t, locale: resolvedLocale, loading }), [t, resolvedLocale, loading]);
