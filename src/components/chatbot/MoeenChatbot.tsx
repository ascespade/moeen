  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed ${positionClasses} z-50 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[var(--primary-primary)] to-purple-600 text-white shadow-2xl transition-all hover:scale-110 hover:shadow-3xl ${
          isOpen ? 'rotate-90' : ''
        }`}
      ...
      {isOpen && (
        ...
        >
          {/* Header */}
          <div className='bg-gradient-to-r from-[var(--primary-primary)] to-purple-600 p-4 text-white'>
              ...
              <div className='grid grid-cols-2 gap-2'>
                {quickActions.map(action => (
                  <button
                    ...
                    className='rounded-lg bg-gray-100 dark:bg-gray-700 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 transition-all hover:bg-[var(--primary-primary)] hover:text-white'
                  >
                    {action.text}
                  </button>
                ))}
          ...
          <div className='border-t dark:border-gray-700 p-4 bg-white dark:bg-gray-800'>
            <div className='flex gap-2'>
              <input
                ...
                className='flex-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-4 py-3 text-gray-900 dark:text-white focus:border-[var(--primary-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--primary-primary)]/20'
                disabled={isLoading}
              />
              <button
                onClick={() => handleSendMessage()}
                disabled={isLoading || !input.trim()}
                className='rounded-lg bg-[var(--primary-primary)] px-4 py-3 text-white transition-all hover:bg-[var(--primary-primary-hover)] disabled:opacity-50 disabled:cursor-not-allowed'
                aria-label='إرسال'
              >
                <svg
                  className='h-6 w-6'
