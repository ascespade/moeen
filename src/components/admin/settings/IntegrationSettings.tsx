          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-sm text-[var(--text-secondary)]'>
                تكامل مع واتساب للرسائل التلقائية
              </p>
            </div>
          </div>
          <div className='flex items-center gap-3'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={e =>
                updateConfig('whatsapp', { accessToken: e.target.value })
              }
              disabled={!config.whatsapp.enabled}
              dir='ltr'
            />
          ...
          <div className='space-y-2 md:col-span-2'>
            ...
            <Input
              ...
              onChange={e =>
                updateConfig('whatsapp', { webhookUrl: e.target.value })
              }
              disabled={!config.whatsapp.enabled}
              dir='ltr'
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={value =>
                updateConfig('payment', { gateway: value })
              }
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={e =>
                updateConfig('payment', { merchantId: e.target.value })
              }
              disabled={!config.payment.enabled}
              dir='ltr'
            />
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={e =>
                updateConfig('payment', { apiKey: e.target.value })
              }
              disabled={!config.payment.enabled}
              dir='ltr'
            />
            ...
            <div>
              ...
              <div className='flex items-center gap-4 text-sm'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span
                    className={
                      config.sms.enabled ? 'text-green-700' : 'text-gray-500'
                    }
                  >
                    SMS
                  </span>
