  ...
  return (
    <div className="ds-container mx-auto py-8">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Buttons - الأزرار</h2>
        <div className="ds-grid ds-grid-cols-2 md:ds-grid-cols-3 lg:ds-grid-cols-6 ds-gap-4">
          <CTAButton variant="primary" size="sm">Primary</CTAButton>
          <CTAButton variant="secondary" size="sm">Secondary</CTAButton>
          <CTAButton variant="outline" size="sm">Outline</CTAButton>
          <CTAButton variant="ghost" size="sm">Ghost</CTAButton>
          <CTAButton variant="danger" size="sm">Danger</CTAButton>
          <CTAButton variant="success" size="sm">Success</CTAButton>
        </div>
        
        <div className="ds-flex ds-justify-center ds-gap-4 mt-6">
          <CTAButton variant="primary" size="xs">XS</CTAButton>
          <CTAButton variant="primary" size="sm">SM</CTAButton>
          <CTAButton variant="primary" size="md">MD</CTAButton>
          <CTAButton variant="primary" size="lg">LG</CTAButton>
          <CTAButton variant="primary" size="xl">XL</CTAButton>
        </div>
        
        <div className="ds-flex ds-justify-center ds-gap-4 mt-6">
          <CTAButton variant="primary" loading={true}>Loading</CTAButton>
          <CTAButton variant="primary" disabled={true}>Disabled</CTAButton>
          <CTAButton variant="primary" fullWidth={true}>Full Width</CTAButton>
        </div>
      </section>

      {/* Cards Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Cards - البطاقات</h2>
      ...
      {/* Stats Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Statistics - الإحصائيات</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Color Palette - لوحة الألوان</h2>
      ...
      {/* Typography Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Typography - الطباعة</h2>
        <div className="ds-card ds-card-lg">
          <div className="ds-card-content space-y-4">
            ...
            <h2 className="text-3xl font-semibold">Heading 2 - العنوان الثانوي</h2>
            ...
            <p className="text-base leading-relaxed">
              This is a paragraph with normal text. It demonstrates the default typography settings
              and how text flows naturally in the design system.
            </p>
      ...
      {/* Spacing Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-center">Spacing - المسافات</h2>
        <div className="ds-card ds-card-lg">
          <div className="ds-card-content">
      ...
      <footer className="ds-card ds-card-elevated ds-card-lg text-center">
        <div className="ds-card-content">
          ...
          <div className="ds-flex ds-justify-center ds-gap-4">
            ...
            <CTAButton variant="outline" size="sm">Documentation</CTAButton>
          </div>
        </div>
      </footer>
    </div>
