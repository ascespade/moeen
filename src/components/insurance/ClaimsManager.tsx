    ...
    <Card className="p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        ...
        >
          ...
          <option value="under_review">{t('insurance.claims.under_review')}</option>
          ...
          <form onSubmit={handleCreateClaim} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => setNewClaim(prev => ({ ...prev, provider: value }))}
                  required
                >
                  <option value="">{t('insurance.claims.select_provider')}</option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNewClaim(prev => ({ ...prev, treatment: e.target.value }))}
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button type="submit" disabled={isCreating}>
                {isCreating ? t('common.creating') : t('insurance.claims.create')}
              </Button>
            </div>
          </form>
        </Card>
