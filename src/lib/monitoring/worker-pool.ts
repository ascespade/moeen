...
export class WorkerPool {
  ...
  private async runCodeAnalysis(task: TaskConfig, cpu: number): Promise<any> {
  ...
  private async runPerformanceCheck(task: TaskConfig, cpu: number): Promise<any> {
  ...
  private async runSecurityCheck(task: TaskConfig, cpu: number): Promise<any> {
  ...
  private async runBrowserTest(task: TaskConfig, cpu: number): Promise<any> {
