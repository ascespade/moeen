...
class ProjectTaskProcessor {
    constructor() {
        ...
        this.logFile = path.join('/home/ubuntu/ai-agent-system/logs/projects/moeen-platform', 'task-processor.log');
        this.taskFile = path.join('/home/ubuntu/ai-agent-system/logs/projects/moeen-platform', 'tasks.json');
        this.statusFile = path.join('/home/ubuntu/ai-agent-system/logs/projects/moeen-platform', 'agent-status.json');
