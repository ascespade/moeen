            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t("flow.subtitle", "إنشاء وإدارة تدفقات المحادثة")}
                </p>
              </div>
            </div>
            ...
            <Card>
              <CardHeader>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {t("flow.templates", "القوالب الجاهزة")}
                </h3>
              </CardHeader>
              ...
              <CardContent>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Eye className="h-4 w-4" /> {t("ui.preview", "معاينة")}
                    </Button>
                    <Button className="inline-flex items-center gap-2">
                      <Save className="h-4 w-4" /> {t("ui.save", "حفظ")}
                    </Button>
                  </div>
                </div>
                ...
                {selectedTemplate ? (
                  <div className="space-y-4">
                    <div
                      ...
                      style={{
                        ...
                        borderColor:
                          "color-mix(in oklab, var(--brand_primary) 35%, transparent)",
                      }}
                    >
                      <h4
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      اختر أحد القوالب الجاهزة لتبدأ في إنشاء تدفق المحادثة
                      الخاص بك
                    </p>
                  </div>
                )}
                ...
                <div className="mt-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <Button
                      ...
                      className="inline-flex items-center gap-1"
                    >
                      <ZoomOut className="h-4 w-4" /> تصغير
                    </Button>
                    <Button
                      variant="secondary"
                      className="inline-flex items-center gap-1"
                    >
                      <Plus className="h-4 w-4" /> إضافة عقدة
                    </Button>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      <svg className="absolute inset-0 w-full h-full pointer-events-none">
                        ...
                        />
                        <path
                          d="M 360 160 C 420 220, 480 240, 600 260"
                          stroke="#22c55e"
                          strokeWidth="2"
                          fill="none"
                        />
