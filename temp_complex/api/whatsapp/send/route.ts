  ...
  try {
    ...
    switch (type) {
      ...
      case 'template':
        ...
        result = await whatsappAPI.sendTemplateMessage(to, templateName, 'ar', parameters || []);
        break;
      ...
      case 'image':
        ...
        result = await whatsappAPI.sendImageMessage(to, content.imageUrl, content.caption);
        break;
      ...
      case 'document':
        ...
        result = await whatsappAPI.sendDocumentMessage(to, content.documentUrl, content.filename, content.caption);
        break;
