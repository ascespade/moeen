...
export const setRefreshToken = (token: string) => storage.set(STORAGE_KEYS.REFRESH_TOKEN, token);
export const removeRefreshToken = () => storage.remove(STORAGE_KEYS.REFRESH_TOKEN);
...
export const setLanguage = (language: string) => storage.set(STORAGE_KEYS.LANGUAGE, language);
