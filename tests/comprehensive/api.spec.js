...
test.describe('API Tests - Comprehensive', () => {
  ...
  test('Medical records API endpoints', async ({ request }) => {
    ...
    const createResponse = await request.post(`${baseURL}/api/medical-records`, {
      data: {
        patientId: 'test-patient-id',
  ...
  test('Insurance claims API endpoints', async ({ request }) => {
    ...
    const createResponse = await request.post(`${baseURL}/api/insurance/claims`, {
      data: {
  ...
  test('Admin API endpoints', async ({ request }) => {
    ...
    const configResponse = await request.get(`${baseURL}/api/admin/system-config`);
