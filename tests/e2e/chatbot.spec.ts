...
test.describe('Healthcare Chatbot', () => {
  ...
  test('should handle appointment inquiry flow', async({ page }) => {
    ...
    const appointmentMessage = page
      .locator('[data-testid="bot-message"]')
      .last();
  ...
  test('should handle long messages', async({ page }) => {
    // Test long message
    const longMessage =
      'أريد حجز موعد مع الدكتور سعد العتيبي في تخصص القلب، وأنا أعاني من ألم في الصدر منذ أسبوع، وأريد فحص شامل';
