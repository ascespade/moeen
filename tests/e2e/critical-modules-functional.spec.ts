  ...
  test.describe('Finance Module Functionality', () => {
    test('should process payment', async ({ page }) => {
      ...
      const processButton = page
        .locator('button:has-text("Process"), button:has-text("Pay")')
        .first();
    ...
    test('should view payment details', async ({ page }) => {
      ...
      const paymentRow = page
        .locator('tr, [role="row"], .payment-item')
        .first();
    ...
    test('should create insurance claim', async ({ page }) => {
      ...
      const addButton = page
        .locator(
          'button:has-text("Add"), button:has-text("New"), button:has-text("Claim")'
        )
        .first();
  ...
  test.describe('Admin Functionality', () => {
    test('should create new user', async ({ page }) => {
      ...
      const addUserButton = page
        .locator('button:has-text("Add User"), button:has-text("New User")')
        .first();
    ...
    test('should filter users by role', async ({ page }) => {
      ...
      const roleFilter = page
        .locator('select, button:has-text("Role")')
        .first();
  ...
  test.describe('sofSettings Functionality', () => {
    test('should change language', async ({ page }) => {
      ...
      const langButton = page
        .locator('button:has-text("عربي"), button:has-text("English"), select')
        .first();
    ...
    test('should toggle RTL/LTR', async ({ page }) => {
      ...
      const dirButton = page
        .locator(
          'button:has-text("RTL"), button:has-text("LTR"), [data-dir-toggle]'
        )
        .first();
    ...
    test('should clear cache/data', async ({ page }) => {
      ...
      const clearButton = page
        .locator('button:has-text("Clear"), button:has-text("Clean")')
        .first();
