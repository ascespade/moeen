...
test.describe('Module 1: Authentication & Authorization - Complete Test Suite', () => {
  ...
  test.describe('Phase 2: UI Tests - Login Page', () => {
    ...
    test('2.3 - UI: Form validation - invalid email format', async ({
      page,
    }) => {
      const emailInput = page
        .locator('input[type="email"], input[name="email"]')
    ...
    test('2.6 - UI: Forgot password link exists', async ({ page }) => {
      const forgotLink = page
        .locator('a:has-text("نسيت"), a:has-text("Forgot"), a[href*="forgot"]')
        .first();
    ...
    test('2.7 - UI: Register link exists', async ({ page }) => {
      const registerLink = page
        .locator(
          'a:has-text("تسجيل"), a:has-text("Register"), a:has-text("Sign up"), a[href*="register"]'
        )
        .first();
  ...
  test.describe('Phase 4: Integration Tests', () => {
    test('4.1 - Integration: Login flow redirects to dashboard', async ({
      page,
    }) => {
      await page.goto('/login');
    ...
    test('4.2 - Integration: Protected route redirects to login', async ({
      page,
    }) => {
    ...
    test('4.3 - Integration: Session persistence check', async ({
      page,
      context,
    }) => {
      await page.goto('/login');
  ...
  test.describe('Phase 5: Use Cases', () => {
    ...
    test('5.4 - Use Case: Multiple login attempts handling', async ({
      page,
    }) => {
      await page.goto('/login');
