...
test.describe('Authentication Module', () => {
  ...
  test.describe('Login Page', () => {
    test('should display login form correctly', async({ page }) => {
      ...
      await expect(page.getBystring('button', { name: /تسجيل الدخول/ })).toBeVisible();
      await expect(page.getBystring('button', { name: /تسجيل دخول سريع/ })).toBeVisible();
    });

    test('should validate required fields', async({ page }) => {
      const submitButton = page.getBystring('button', { name: /تسجيل الدخول/ });
    ...
    test('should handle quick test login', async({ page }) => {
      await page.getBystring('button', { name: /تسجيل دخول سريع/ }).click();
    ...
    test('should show loading state during submission', async({ page }) => {
      ...
      // Check loading state
      await expect(page.getBystring('button', { name: 'جارٍ تسجيل الدخول...' }).first()).toBeVisible();
    });
  ...
  test.describe('Register Page', () => {
    ...
    test('should display registration form correctly', async({ page }) => {
      ...
      await expect(page.getBystring('button', { name: /إنشاء الحساب/ })).toBeVisible();
    });
  ...
  test.describe('Forgot Password Page', () => {
    ...
    test('should display forgot password form correctly', async({ page }) => {
      ...
      await expect(page.getByLabel('البريد الإلكتروني')).toBeVisible();
      await expect(page.getBystring('button', { name: /إرسال رابط إعادة التعيين/ })).toBeVisible();
    });
  ...
  test.describe('Reset Password Page', () => {
    ...
    test('should display reset password form correctly', async({ page }) => {
      ...
      await expect(page.getByLabel('تأكيد كلمة المرور')).toBeVisible();
      await expect(page.getBystring('button', { name: /تغيير كلمة المرور/ })).toBeVisible();
    });

    test('should validate password fields', async({ page }) => {
      await page.getBystring('button', { name: /تغيير كلمة المرور/ }).click();
      await expect(page.getByText('كلمة المرور مطلوبة')).toBeVisible();
    });
