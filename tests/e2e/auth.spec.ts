...
test.describe('Authentication Module', () => {
  ...
  test.describe('Login Page', () => {
    test('should display login form correctly', async ({ page }) => {
      ...
      await expect(
        page.getByText('سجل دخولك للوصول إلى لوحة التحكم')
      ).toBeVisible();
      ...
      await expect(
        page.getByRole('button', { name: /تسجيل دخول سريع/ })
      ).toBeVisible();
    });
    ...
    test('should show loading state during submission', async ({ page }) => {
      ...
      // Check loading state
      await expect(
        page.getByRole('button', { name: 'جارٍ تسجيل الدخول...' }).first()
      ).toBeVisible();
    });
  ...
  test.describe('Register Page', () => {
    ...
    test('should display registration form correctly', async ({ page }) => {
      ...
      await expect(
        page.getByText('انضم إلى منصة الرعاية الصحية المتخصصة')
      ).toBeVisible();
    ...
    test('should validate form fields', async ({ page }) => {
      ...
      await expect(
        page.getByText('يجب الموافقة على الشروط والأحكام')
      ).toBeVisible();
    });
    ...
    test('should validate password length', async ({ page }) => {
      ...
      await expect(
        page.getByText('كلمة المرور يجب أن تكون 6 أحرف على الأقل')
      ).toBeVisible();
    });
  ...
  test.describe('Authentication Flow', () => {
    test('should complete full registration to login flow', async ({
      page,
    }) => {
    ...
    test('should handle forgot password to reset password flow', async ({
      page,
    }) => {
