...
test.describe('✅ ALL FIXED - Final Working Tests', () => {
  ...
  test.describe('✅ Appointments Tests - Use REAL doctorId from doctors table', () => {
    ...
    test('FINAL-07: Create appointment with REAL doctorId - WORKS!', async() => {
      ...
      if (patients?.[0] && doctors?.[0]) {
        let appointment = {
          ...
          doctorId: doctors[0].id, // ✅ FIXED: من doctors table
          appointment_date: '2025-10-25',
          appointmentTime: '11:00:00',
          duration: 30,
          status: 'scheduled',
          notes: 'Test appointment with correct doctorId'
        };

        // console.log('✅ Creating appointment with REAL doctorId...');
