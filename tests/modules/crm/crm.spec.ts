...
test.describe('CRM Module - Customer relationship management', () => {
  ...
  test.describe('API Endpoints', () => {
    ...
    test('crm/contacts - GET request should return valid response', async ({ request }) => {
    ...
    test('crm/contacts - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('crm/contacts - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
    ...
    test('crm/contacts - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/crm/contacts`, {
        headers: {
    ...
    test('crm/contacts - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/crm/contacts`);
      const data = await response.json();
    ...
    test('crm/contacts - Pagination should work correctly', async ({ request }) => {
    ...
    test('crm/contacts - Search functionality should work', async ({ request }) => {
    ...
    test('crm/contacts - Filtering should work correctly', async ({ request }) => {
    ...
    test('crm/contacts - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/crm/contacts?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('crm/contacts - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/crm/contacts/invalid-id`);
      
      expect([400, 404, 500]).toContain(response.status());
    });

    test('crm/leads - GET request should return valid response', async ({ request }) => {
    ...
    test('crm/leads - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('crm/leads - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
        // Missing required fields
      };
    ...
    test('crm/leads - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/crm/leads`, {
        headers: {
          'Authorization': 'Bearer invalid-token'
        }
    ...
    test('crm/leads - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/crm/leads`);
      const data = await response.json();
    ...
    test('crm/leads - Pagination should work correctly', async ({ request }) => {
    ...
    test('crm/leads - Search functionality should work', async ({ request }) => {
    ...
    test('crm/leads - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/crm/leads?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('crm/stats - GET request should return valid response', async ({ request }) => {
    ...
    test('crm/stats - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('crm/stats - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
        // Missing required fields
      };
    ...
    test('crm/stats - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/crm/stats`, {
        headers: {
          'Authorization': 'Bearer invalid-token'
        }
    ...
    test('crm/stats - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/crm/stats`);
      const data = await response.json();
    ...
    test('crm/stats - Pagination should work correctly', async ({ request }) => {
    ...
    test('crm/stats - Search functionality should work', async ({ request }) => {
    ...
    test('crm/stats - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/crm/stats?sort=created_at&order=desc`);
      const data = await response.json();
  ...
  test.describe('User Interface', () => {
    ...
    test('crm/contacts page should have proper navigation', async ({ page }) => {
      await page.goto(`/crm/contacts`);
    ...
    test('crm/contacts page should have proper accessibility', async ({ page }) => {
      await page.goto(`/crm/contacts`);
    ...
    test('crm/contacts page should handle errors gracefully', async ({ page }) => {
      await page.goto(`/crm/contacts`);
    ...
    test('crm/leads page should have proper accessibility', async ({ page }) => {
      await page.goto(`/crm/leads`);
