...
test.describe('SESSIONS Module - Therapy and treatment sessions', () => {
  let testUser: any;
  let testPatient: any;
  let testDoctor: any;
  ...
  test.describe('API Endpoints', () => {
    ...
    test('sessions - GET request should return valid response', async ({ request }) => {
    ...
    test('sessions - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('sessions - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
    ...
    test('sessions - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/sessions`, {
        headers: {
    ...
    test('sessions - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/sessions`);
      const data = await response.json();
    ...
    test('sessions - Pagination should work correctly', async ({ request }) => {
    ...
    test('sessions - Search functionality should work', async ({ request }) => {
      const response = await request.get(`/api/sessions?search=test`);
      const data = await response.json();
    ...
    test('sessions - Filtering should work correctly', async ({ request }) => {
      const response = await request.get(`/api/sessions?status=active`);
      const data = await response.json();
    ...
    test('sessions - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/sessions?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('sessions - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/sessions/invalid-id`);
  ...
  test.describe('User Interface', () => {
    ...
    test('sessions page should load correctly', async ({ page }) => {
      await page.goto(`/sessions`);
      await expect(page).toHaveTitle(/مركز الهمم/);
      await expect(page.locator('body')).toBeVisible();
    });

    test('sessions page should have proper navigation', async ({ page }) => {
      await page.goto(`/sessions`);
    ...
    test('sessions page should have proper accessibility', async ({ page }) => {
      await page.goto(`/sessions`);
    ...
    test('sessions page should handle loading states', async ({ page }) => {
      await page.goto(`/sessions`);
    ...
    test('sessions page should handle errors gracefully', async ({ page }) => {
      await page.goto(`/sessions`);
