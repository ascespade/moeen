...
test.describe('TRAINING Module - Training programs and modules', () => {
  ...
  test.describe('API Endpoints', () => {
    test('training - GET request should return valid response', async ({
      request,
    }) => {
    ...
    test('training - POST request should create new record', async ({
      request,
    }) => {
      const testData = {
        name: 'Test Record',
    ...
    test('training - Invalid data should return 400 error', async ({
      request,
    }) => {
      const invalidData = {
    ...
    test('training - Unauthorized request should return 401', async ({
      request,
    }) => {
      const response = await request.get(`/api/training`, {
        headers: {
    ...
    test('training - Response should have proper structure', async ({
      request,
    }) => {
      const response = await request.get(`/api/training`);
      const data = await response.json();
    ...
    test('training - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(
        `/api/training?sort=created_at&order=desc`
      );
      const data = await response.json();
  ...
  test.describe('Integration Tests', () => {
    ...
    test('Module should handle concurrent users', async ({ browser }) => {
      ...
      await Promise.all([page1.goto('/training'), page2.goto('/training')]);
