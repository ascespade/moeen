...
test.describe('PATIENTS Module - Patient management system', () => {
  let testUser: any;
  let testPatient: any;
  let testDoctor: any;
  ...
  test.describe('User Interface', () => {
    ...
    test('patients page should have proper navigation', async ({ page }) => {
      await page.goto(`/patients`);
    ...
    test('patients/[id] page should load correctly', async ({ page }) => {
