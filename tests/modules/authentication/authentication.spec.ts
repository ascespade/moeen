...
test.describe('AUTHENTICATION Module - User authentication and authorization', () => {
  ...
  test.describe('API Endpoints', () => {
    ...
    test('auth/login - GET request should return valid response', async ({ request }) => {
    ...
    test('auth/login - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('auth/login - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
    ...
    test('auth/login - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/auth/login`, {
        headers: {
    ...
    test('auth/login - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/auth/login`);
      const data = await response.json();
    ...
    test('auth/login - Pagination should work correctly', async ({ request }) => {
    ...
    test('auth/login - Search functionality should work', async ({ request }) => {
    ...
    test('auth/login - Filtering should work correctly', async ({ request }) => {
    ...
    test('auth/login - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/login?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('auth/login - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/auth/login/invalid-id`);
      
      expect([400, 404, 500]).toContain(response.status());
    });

    test('auth/register - GET request should return valid response', async ({ request }) => {
    ...
    test('auth/register - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('auth/register - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
        // Missing required fields
      };
    ...
    test('auth/register - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/auth/register`, {
        headers: {
          'Authorization': 'Bearer invalid-token'
        }
    ...
    test('auth/register - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/auth/register`);
      const data = await response.json();
    ...
    test('auth/register - Pagination should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/register?limit=10&offset=0`);
      const data = await response.json();
    ...
    test('auth/register - Search functionality should work', async ({ request }) => {
    ...
    test('auth/register - Filtering should work correctly', async ({ request }) => {
    ...
    test('auth/register - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/register?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('auth/register - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/auth/register/invalid-id`);
      
      expect([400, 404, 500]).toContain(response.status());
    });

    test('auth/forgot-password - GET request should return valid response', async ({ request }) => {
    ...
    test('auth/forgot-password - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('auth/forgot-password - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
        // Missing required fields
      };
    ...
    test('auth/forgot-password - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/auth/forgot-password`, {
        headers: {
          'Authorization': 'Bearer invalid-token'
        }
    ...
    test('auth/forgot-password - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/auth/forgot-password`);
      const data = await response.json();
    ...
    test('auth/forgot-password - Pagination should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/forgot-password?limit=10&offset=0`);
      const data = await response.json();
    ...
    test('auth/forgot-password - Search functionality should work', async ({ request }) => {
      const response = await request.get(`/api/auth/forgot-password?search=test`);
      const data = await response.json();
    ...
    test('auth/forgot-password - Filtering should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/forgot-password?status=active`);
      const data = await response.json();
    ...
    test('auth/forgot-password - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/forgot-password?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('auth/forgot-password - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/auth/forgot-password/invalid-id`);
      
      expect([400, 404, 500]).toContain(response.status());
    });

    test('auth/reset-password - GET request should return valid response', async ({ request }) => {
    ...
    test('auth/reset-password - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('auth/reset-password - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
        // Missing required fields
      };
    ...
    test('auth/reset-password - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/auth/reset-password`, {
        headers: {
          'Authorization': 'Bearer invalid-token'
        }
    ...
    test('auth/reset-password - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/auth/reset-password`);
      const data = await response.json();
    ...
    test('auth/reset-password - Pagination should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/reset-password?limit=10&offset=0`);
      const data = await response.json();
    ...
    test('auth/reset-password - Search functionality should work', async ({ request }) => {
      const response = await request.get(`/api/auth/reset-password?search=test`);
      const data = await response.json();
    ...
    test('auth/reset-password - Filtering should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/reset-password?status=active`);
      const data = await response.json();
    ...
    test('auth/reset-password - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/reset-password?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('auth/reset-password - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/auth/reset-password/invalid-id`);
      
      expect([400, 404, 500]).toContain(response.status());
    });

    test('auth/me - GET request should return valid response', async ({ request }) => {
    ...
    test('auth/me - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('auth/me - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
        // Missing required fields
      };
    ...
    test('auth/me - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/auth/me`, {
        headers: {
          'Authorization': 'Bearer invalid-token'
        }
    ...
    test('auth/me - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/auth/me`);
      const data = await response.json();
    ...
    test('auth/me - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/me?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('auth/logout - GET request should return valid response', async ({ request }) => {
    ...
    test('auth/logout - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('auth/logout - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
        // Missing required fields
      };
    ...
    test('auth/logout - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/auth/logout`, {
        headers: {
          'Authorization': 'Bearer invalid-token'
        }
    ...
    test('auth/logout - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/auth/logout`);
      const data = await response.json();
    ...
    test('auth/logout - Pagination should work correctly', async ({ request }) => {
    ...
    test('auth/logout - Search functionality should work', async ({ request }) => {
    ...
    test('auth/logout - Filtering should work correctly', async ({ request }) => {
    ...
    test('auth/logout - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/auth/logout?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('auth/logout - Error handling should be proper', async ({ request }) => {
  ...
  test.describe('User Interface', () => {
    ...
    test('forgot-password page should have proper navigation', async ({ page }) => {
      await page.goto(`/forgot-password`);
      await expect(page.locator('nav')).toBeVisible();
      await expect(page.locator('a[href="/dashboard"]')).toBeVisible();
    });
    ...
    test('forgot-password page should have proper accessibility', async ({ page }) => {
      await page.goto(`/forgot-password`);
    ...
    test('forgot-password page should handle loading states', async ({ page }) => {
      await page.goto(`/forgot-password`);
    ...
    test('forgot-password page should handle errors gracefully', async ({ page }) => {
      await page.goto(`/forgot-password`);
    ...
    test('reset-password page should have proper navigation', async ({ page }) => {
      await page.goto(`/reset-password`);
      await expect(page.locator('nav')).toBeVisible();
      await expect(page.locator('a[href="/dashboard"]')).toBeVisible();
    });
    ...
    test('reset-password page should have proper accessibility', async ({ page }) => {
      await page.goto(`/reset-password`);
    ...
    test('reset-password page should handle loading states', async ({ page }) => {
      await page.goto(`/reset-password`);
    ...
    test('reset-password page should handle errors gracefully', async ({ page }) => {
      await page.goto(`/reset-password`);
    ...
    test('verify-email page should have proper navigation', async ({ page }) => {
      await page.goto(`/verify-email`);
      await expect(page.locator('nav')).toBeVisible();
      await expect(page.locator('a[href="/dashboard"]')).toBeVisible();
    });
    ...
    test('verify-email page should have proper accessibility', async ({ page }) => {
      await page.goto(`/verify-email`);
    ...
    test('verify-email page should handle errors gracefully', async ({ page }) => {
      await page.goto(`/verify-email`);
