...
test.describe('DOCTORS Module - Doctor management and profiles', () => {
  ...
  test.describe('API Endpoints', () => {
    test('doctors - GET request should return valid response', async ({
      request,
    }) => {
    ...
    test('doctors - POST request should create new record', async ({
      request,
    }) => {
      const testData = {
        name: 'Test Record',
    ...
    test('doctors - Invalid data should return 400 error', async ({
      request,
    }) => {
      const invalidData = {
    ...
    test('doctors - Unauthorized request should return 401', async ({
      request,
    }) => {
      const response = await request.get(`/api/doctors`, {
        headers: {
    ...
    test('doctors - Response should have proper structure', async ({
      request,
    }) => {
      const response = await request.get(`/api/doctors`);
      const data = await response.json();
    ...
    test('doctors - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(
        `/api/doctors?sort=created_at&order=desc`
      );
      const data = await response.json();
  ...
  test.describe('Integration Tests', () => {
    ...
    test('Module should handle concurrent users', async ({ browser }) => {
      ...
      await Promise.all([page1.goto('/doctors'), page2.goto('/doctors')]);
