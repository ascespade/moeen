...
test.describe('DOCTORS Module - Doctor management and profiles', () => {
  let testUser: any;
  let testPatient: any;
  let testDoctor: any;
  ...
  test.describe('API Endpoints', () => {
    ...
    test('doctors - GET request should return valid response', async ({ request }) => {
    ...
    test('doctors - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('doctors - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
    ...
    test('doctors - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/doctors`, {
        headers: {
    ...
    test('doctors - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/doctors`);
      const data = await response.json();
    ...
    test('doctors - Pagination should work correctly', async ({ request }) => {
      const response = await request.get(`/api/doctors?limit=10&offset=0`);
      const data = await response.json();
    ...
    test('doctors - Search functionality should work', async ({ request }) => {
      const response = await request.get(`/api/doctors?search=test`);
      const data = await response.json();
    ...
    test('doctors - Filtering should work correctly', async ({ request }) => {
      const response = await request.get(`/api/doctors?status=active`);
      const data = await response.json();
    ...
    test('doctors - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/doctors?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('doctors - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/doctors/invalid-id`);
  ...
  test.describe('User Interface', () => {
    ...
    test('doctors page should load correctly', async ({ page }) => {
      await page.goto(`/doctors`);
      await expect(page).toHaveTitle(/مركز الهمم/);
      await expect(page.locator('body')).toBeVisible();
    });

    test('doctors page should have proper navigation', async ({ page }) => {
      await page.goto(`/doctors`);
      await expect(page.locator('nav')).toBeVisible();
      await expect(page.locator('a[href="/dashboard"]')).toBeVisible();
    });

    test('doctors page should be responsive', async ({ page }) => {
      await page.goto(`/doctors`);
    ...
    test('doctors page should have proper accessibility', async ({ page }) => {
      await page.goto(`/doctors`);
    ...
    test('doctors page should handle loading states', async ({ page }) => {
      await page.goto(`/doctors`);
    ...
    test('doctors page should handle errors gracefully', async ({ page }) => {
      await page.goto(`/doctors`);
