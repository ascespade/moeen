...
test.describe('INSURANCE Module - Insurance claims and management', () => {
  let testUser: any;
  let testPatient: any;
  let testDoctor: any;
  ...
  test.describe('User Interface', () => {
    ...
    test('insurance page should have proper navigation', async ({ page }) => {
      await page.goto(`/insurance`);
    ...
    test('insurance-claims page should load correctly', async ({ page }) => {
