...
test.describe('SETTINGS Module - System settings and configuration', () => {
  let testUser: any;
  let testPatient: any;
  let testDoctor: any;
  ...
  test.describe('API Endpoints', () => {
    ...
    test('settings - GET request should return valid response', async ({ request }) => {
    ...
    test('settings - POST request should create new record', async ({ request }) => {
      const testData = {
        name: 'Test Record',
        phone: '+966501234570',
        email: 'test@example.com'
    ...
    test('settings - Invalid data should return 400 error', async ({ request }) => {
      const invalidData = {
    ...
    test('settings - Unauthorized request should return 401', async ({ request }) => {
      const response = await request.get(`/api/settings`, {
        headers: {
    ...
    test('settings - Response should have proper structure', async ({ request }) => {
      const response = await request.get(`/api/settings`);
      const data = await response.json();
    ...
    test('settings - Pagination should work correctly', async ({ request }) => {
      const response = await request.get(`/api/settings?limit=10&offset=0`);
      const data = await response.json();
    ...
    test('settings - Search functionality should work', async ({ request }) => {
      const response = await request.get(`/api/settings?search=test`);
      const data = await response.json();
    ...
    test('settings - Filtering should work correctly', async ({ request }) => {
      const response = await request.get(`/api/settings?status=active`);
      const data = await response.json();
    ...
    test('settings - Sorting should work correctly', async ({ request }) => {
      const response = await request.get(`/api/settings?sort=created_at&order=desc`);
      const data = await response.json();
    ...
    test('settings - Error handling should be proper', async ({ request }) => {
      const response = await request.get(`/api/settings/invalid-id`);
  ...
  test.describe('User Interface', () => {
    ...
    test('settings page should have proper navigation', async ({ page }) => {
      await page.goto(`/settings`);
    ...
    test('settings page should have proper accessibility', async ({ page }) => {
      await page.goto(`/settings`);
    ...
    test('settings page should handle loading states', async ({ page }) => {
      await page.goto(`/settings`);
    ...
    test('settings page should handle errors gracefully', async ({ page }) => {
      await page.goto(`/settings`);
