...
test.describe('Notifications Module - Comprehensive Tests', () => {
  ...
  test.describe('Notifications List View', () => {
    ...
    test('should show notification information correctly', async ({ page }) => {
      ...
      await expect(notificationItem.locator('[data-testid="notification-title"]')).toContainText(firstNotification!.title);
      await expect(notificationItem.locator('[data-testid="notification-message"]')).toContainText(firstNotification!.message);
      await expect(notificationItem.locator('[data-testid="notification-priority"]')).toBeVisible();
      await expect(notificationItem.locator('[data-testid="notification-type"]')).toBeVisible();
    });

    test('should filter notifications by type', async ({ page }) => {
      await page.goto('/notifications');
      
      await page.selectOption('[data-testid="type-filter"]', 'appointment_reminder');
    ...
    test('should filter notifications by read status', async ({ page }) => {
      ...
      const readStatuses = await page.locator('[data-testid="read-status"]').allTextContents();
    ...
    test('should sort notifications by date', async ({ page }) => {
      ...
      const dates = await page.locator('[data-testid="notification-date"]').allTextContents();
  ...
  test.describe('Create New Notification', () => {
    ...
    test('should open create notification form', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="create-notification-form"]')).toBeVisible();
    });
    ...
    test('should create notification successfully', async ({ page }) => {
      ...
      await page.selectOption('[data-testid="type-select"]', 'appointment_reminder');
      ...
      await page.fill('[data-testid="data-input"]', '{"appointment_id": "125"}');
      
      await page.click('[data-testid="create-notification-button"]');
      
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Notification created successfully');
    ...
    test('should create notification for multiple users', async ({ page }) => {
      ...
      await page.fill('[data-testid="message-input"]', 'تنبيه مهم لجميع المستخدمين');
    ...
    test('should validate required fields', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="user-error"]')).toContainText('User is required');
    ...
    test('should validate message length', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="message-error"]')).toContainText('Message must be less than 1000 characters');
    });
    ...
    test('should validate JSON data format', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="data-error"]')).toContainText('Data must be valid JSON');
    });
    ...
    test('should show loading state during creation', async ({ page }) => {
      ...
      await page.selectOption('[data-testid="user-select"]', user.id);
      await page.selectOption('[data-testid="type-select"]', 'appointment_reminder');
      await page.fill('[data-testid="title-input"]', 'Loading Test Notification');
      await page.fill('[data-testid="message-input"]', 'Test message');
      await page.click('[data-testid="create-notification-button"]');
    ...
    test('should cancel form without creating', async ({ page }) => {
      ...
      await page.fill('[data-testid="title-input"]', 'Cancel Test Notification');
      await page.fill('[data-testid="message-input"]', 'Test message');
      await page.click('[data-testid="cancel-button"]');
      
      await expect(page).toHaveURL('/notifications');
      await expect(page.locator('[data-testid="create-notification-form"]')).not.toBeVisible();
    });
  });
  ...
  test.describe('Notification Details and Management', () => {
    ...
    test('should show notification metadata', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="notification-type"]')).toContainText(notification!.type);
      await expect(page.locator('[data-testid="notification-priority"]')).toContainText(notification!.priority);
    ...
    test('should show notification data', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="notification-data"]')).toBeVisible();
      await expect(page.locator('[data-testid="data-json"]')).toContainText(JSON.stringify(notification!.data));
    });
    ...
    test('should mark notification as read', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="read-status"]')).toContainText('مقروء');
    });
    ...
    test('should mark notification as unread', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Notification marked as unread');
      await expect(page.locator('[data-testid="read-status"]')).toContainText('غير مقروء');
    });
    ...
    test('should delete notification', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Notification deleted successfully');
      await expect(page).toHaveURL('/notifications');
    });
    ...
    test('should show delete confirmation dialog', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="delete-message"]')).toContainText(notification!.title);
    });
  ...
  test.describe('Bulk Notification Operations', () => {
    ...
    test('should select multiple notifications', async ({ page }) => {
      ...
      const selectedCheckboxes = await page.locator('[data-testid="notification-checkbox"]:checked').count();
    ...
    test('should mark multiple notifications as read', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Notifications marked as read');
    });
    ...
    test('should mark multiple notifications as unread', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Notifications marked as unread');
    });
    ...
    test('should delete multiple notifications', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Notifications deleted successfully');
    });
    ...
    test('should hide bulk operations toolbar when no selections', async ({ page }) => {
      await page.goto('/notifications');
  ...
  test.describe('Notification Templates', () => {
    ...
    test('should display notification templates', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="template-item"]')).toHaveCount(5);
    });
    ...
    test('should create new template', async ({ page }) => {
      ...
      await page.selectOption('[data-testid="template-type-select"]', 'appointment_reminder');
      await page.fill('[data-testid="template-title-input"]', 'تذكير بالموعد');
      await page.fill('[data-testid="template-message-input"]', 'لديك موعد غداً في الساعة {{time}}');
      await page.fill('[data-testid="template-variables-input"]', 'time,date,patient_name');
    ...
    test('should edit existing template', async ({ page }) => {
      ...
      await page.fill('[data-testid="template-message-input"]', 'لديك موعد غداً في الساعة {{time}} مع الدكتور {{doctor_name}}');
      await page.click('[data-testid="save-template-button"]');
    ...
    test('should preview template', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="preview-message"]')).toBeVisible();
    });
  });
  ...
  test.describe('Accessibility Tests', () => {
    ...
    test('should have proper ARIA labels', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="create-notification-button"]')).toHaveAttribute('aria-label');
      await expect(page.locator('[data-testid="notification-item"]').first()).toHaveAttribute('aria-label');
    });
    ...
    test('should support keyboard navigation', async ({ page }) => {
      ...
      await page.keyboard.press('Tab');
      await expect(page.locator('[data-testid="create-notification-button"]')).toBeFocused();
    });
    ...
    test('should announce notification updates to screen readers', async ({ page }) => {
      ...
      const announcementElement = page.locator('[data-testid="notification-update-announcement"]');
