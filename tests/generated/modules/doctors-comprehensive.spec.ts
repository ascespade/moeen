...
test.describe('Doctors Module - Comprehensive Tests', () => {
  ...
  test.describe('Doctors List View', () => {
    ...
    test('should show doctor information correctly', async ({ page }) => {
      ...
      await expect(
        doctorCard.locator('[data-testid="doctor-name"]')
      ).toContainText(firstDoctor!.speciality);
      await expect(
        doctorCard.locator('[data-testid="doctor-speciality"]')
      ).toBeVisible();
      await expect(
        doctorCard.locator('[data-testid="doctor-experience"]')
      ).toBeVisible();
      await expect(
        doctorCard.locator('[data-testid="doctor-rating"]')
      ).toBeVisible();
    });
    ...
    test('should filter doctors by speciality', async ({ page }) => {
      ...
      await page.selectOption(
        '[data-testid="speciality-filter"]',
        'العلاج الطبيعي'
      );
      await page.click('[data-testid="apply-filters"]');

      const specialityBadges = await page
        .locator('[data-testid="speciality-badge"]')
        .allTextContents();
      expect(
        specialityBadges.every(speciality => speciality === 'العلاج الطبيعي')
      ).toBe(true);
    });
    ...
    test('should filter doctors by experience', async ({ page }) => {
      ...
      const experienceElements = await page
        .locator('[data-testid="doctor-experience"]')
        .allTextContents();
    ...
    test('should filter doctors by rating', async ({ page }) => {
      ...
      const ratingElements = await page
        .locator('[data-testid="doctor-rating"]')
        .allTextContents();
    ...
    test('should show doctor count', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="doctor-count"]')).toContainText(
        '3'
      );
    });
  ...
  test.describe('Doctor Details View', () => {
    ...
    test('should display doctor details', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="doctor-details"]')
      ).toBeVisible();
      await expect(page.locator('[data-testid="doctor-name"]')).toContainText(
        doctor!.speciality
      );
      await expect(
      ...
      await expect(
        page.locator('[data-testid="doctor-experience"]')
      ).toBeVisible();
    });
    ...
    test('should show doctor qualifications', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="qualifications"]')
      ).toBeVisible();
    ...
    test('should show doctor languages', async ({ page }) => {
      ...
      for (const language of doctor!.languages) {
        await expect(page.locator('[data-testid="languages"]')).toContainText(
          language
        );
      }
    });
    ...
    test('should show doctor bio', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="doctor-bio"]')).toContainText(
        doctor!.bio
      );
    });
    ...
    test('should show doctor schedule', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="doctor-schedule"]')
      ).toBeVisible();
    });
  });
  ...
  test.describe('Add New Doctor', () => {
    ...
    test('should open add doctor form', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="add-doctor-form"]')
      ).toBeVisible();
    });
    ...
    test('should create new doctor successfully', async ({ page }) => {
      ...
      await page.fill(
        ...
        'أخصائية علاج طبيعي متخصصة في الأطفال'
      );

      // Add qualifications
      await page.click('[data-testid="add-qualification"]');
      await page.fill(
        '[data-testid="qualification-input-0"]',
        'بكالوريوس العلاج الطبيعي'
      );
      await page.click('[data-testid="add-qualification"]');
      await page.fill(
        '[data-testid="qualification-input-1"]',
        'ماجستير طب الأطفال'
      );
      ...
      ).toContainText('Doctor created successfully');
    ...
    test('should validate required fields', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="speciality-error"]')
      ).toContainText('Speciality is required');
    });
    ...
    test('should validate experience years', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="experience-years-error"]')
      ).toContainText('Experience years must be positive');
    });
  ...
  test.describe('Edit Doctor', () => {
    ...
    test('should open edit doctor form', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="edit-doctor-form"]')
      ).toBeVisible();
    });
    ...
    test('should update doctor information', async ({ page }) => {
      ...
      await page.fill(
        '[data-testid="bio-input"]',
        'أخصائي علاج طبيعي متخصص في إصابات العمود الفقري - محدث'
      );
      await page.fill('[data-testid="experience-years-input"]', '6');
      ...
      await expect(
        page.locator('[data-testid="success-message"]')
      ).toContainText('Doctor updated successfully');
    });
    ...
    test('should update qualifications', async ({ page }) => {
      ...
      await page.click('[data-testid="add-qualification"]');
      await page.fill(
        '[data-testid="qualification-input-2"]',
  ...
  test.describe('Doctor Availability Management', () => {
    ...
    test('should set custom availability', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="success-message"]')
      ).toContainText('Custom availability set');
    });
  ...
  test.describe('Doctor Reviews and Ratings', () => {
    ...
    test('should add new review', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="success-message"]')
      ).toContainText('Review added successfully');
    });
    ...
    test('should filter reviews by rating', async ({ page }) => {
      ...
      const reviewRatings = await page
        .locator('[data-testid="review-rating"]')
        .allTextContents();
  ...
  test.describe('Doctor Statistics and Reports', () => {
    ...
    test('should display doctor performance metrics', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="appointments-completed"]')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="patient-satisfaction"]')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="average-session-duration"]')
      ).toBeVisible();
    });
  ...
  test.describe('Accessibility Tests', () => {
    ...
    test('should have proper ARIA labels', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="add-doctor-button"]')
      ).toHaveAttribute('aria-label');
      await expect(
        page.locator('[data-testid="doctor-card"]').first()
      ).toHaveAttribute('aria-label');
    });
