...
test.describe('Patients Module - Comprehensive Tests', () => {
  ...
  test.describe('Patient List View', () => {
    ...
    test('should show patient information correctly', async ({ page }) => {
      ...
      await expect(
        patientCard.locator('[data-testid="patient-name"]')
      ).toContainText(firstPatient!.full_name);
      await expect(
        patientCard.locator('[data-testid="patient-phone"]')
      ).toContainText(firstPatient!.phone);
      await expect(
        patientCard.locator('[data-testid="patient-email"]')
      ).toContainText(firstPatient!.email);
    });
    ...
    test('should filter patients by name', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="patient-name"]').first()
      ).toContainText('أحمد');
    });
    ...
    test('should filter patients by phone', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="patient-card"]')).toHaveCount(1);
      await expect(
        page.locator('[data-testid="patient-phone"]').first()
      ).toContainText('234200');
    });
    ...
    test('should filter patients by email', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="patient-card"]')).toHaveCount(1);
      await expect(
        page.locator('[data-testid="patient-email"]').first()
      ).toContainText('fatima');
    });
    ...
    test('should sort patients by creation date', async ({ page }) => {
      ...
      const dates = await page
        .locator('[data-testid="patient-date"]')
        .allTextContents();
    ...
    test('should paginate patients list', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="page-info"]')).toContainText(
        '1 of 1'
      );
    });
    ...
    test('should show patient count', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="patient-count"]')).toContainText(
        '3'
      );
    });
  });
  ...
  test.describe('Patient Details View', () => {
    ...
    test('should display patient details', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="patient-phone"]')).toContainText(
        patient!.phone
      );
      await expect(page.locator('[data-testid="patient-email"]')).toContainText(
        patient!.email
      );
    });
    ...
    test('should show medical history', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="medical-history"]')
      ).toBeVisible();
    ...
    test('should show medications', async ({ page }) => {
      ...
      for (const medication of patient!.medications) {
        await expect(page.locator('[data-testid="medications"]')).toContainText(
          medication
        );
      }
    });
    ...
    test('should show insurance information', async ({ page }) => {
      ...
      ).toContainText(patient!.insurance_provider);
      await expect(
        page.locator('[data-testid="insurance-number"]')
      ).toContainText(patient!.insurance_number);
    });
    ...
    test('should show emergency contact', async ({ page }) => {
      ...
      ).toContainText(patient!.emergency_contact);
    });
    ...
    test('should show patient statistics', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="appointments-count"]')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="sessions-count"]')
      ).toBeVisible();
    ...
    test('should show recent sessions', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="recent-sessions"]')
      ).toBeVisible();
    });
  });
  ...
  test.describe('Add New Patient', () => {
    ...
    test('should validate required fields', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="full-name-error"]')
    ...
    test('should validate date of birth', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="date-of-birth-error"]')
      ).toContainText('Date of birth cannot be in the future');
    });
  ...
  test.describe('Edit Patient', () => {
    ...
    test('should open edit patient form', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="edit-patient-form"]')
      ).toBeVisible();
    });
    ...
    test('should update patient information', async ({ page }) => {
      ...
      await page.fill(
        '[data-testid="full-name-input"]',
        'أحمد محمد العلي - محدث'
      );
      await page.fill(
        '[data-testid="address-input"]',
        'الرياض، حي النرجس - العنوان الجديد'
      );
      await page.click('[data-testid="save-patient-button"]');

      await expect(
        page.locator('[data-testid="success-message"]')
      ).toContainText('Patient updated successfully');
    });
  ...
  test.describe('Delete Patient', () => {
    ...
    test('should show delete confirmation dialog', async ({ page }) => {
      ...
      ).toContainText(patient!.full_name);
    });
    ...
    test('should delete patient when confirmed', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="success-message"]')
      ).toContainText('Patient deleted successfully');
      await expect(page).toHaveURL('/patients');
    });
    ...
    test('should prevent deletion of patient with appointments', async ({
      page,
    }) => {
  ...
  test.describe('Patient Search and Filtering', () => {
    ...
    test('should filter by gender', async ({ page }) => {
      ...
      const genderBadges = await page
        .locator('[data-testid="gender-badge"]')
        .allTextContents();
