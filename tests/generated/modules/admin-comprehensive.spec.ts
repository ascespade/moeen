...
test.describe('Admin Module - Comprehensive Tests', () => {
  ...
  test.describe('Admin Dashboard', () => {
    ...
    test('should display system health', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="storage-status"]')).toContainText('متاح');
    });
  ...
  test.describe('User Management', () => {
    ...
    test('should activate/deactivate user', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('User status updated');
    });
  ...
  test.describe('System Settings', () => {
    ...
    test('should update general settings', async ({ page }) => {
      ...
      await page.fill('[data-testid="site-description-input"]', 'مركز متخصص في العلاج الطبيعي والوظيفي');
    ...
    test('should update security settings', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Security settings updated');
    });
    ...
    test('should update notification settings', async ({ page }) => {
      ...
      await page.fill('[data-testid="notification-email-input"]', 'notifications@moeen.com');
      
      await page.click('[data-testid="save-settings-button"]');
      
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Notification settings updated');
    });
  });
  ...
  test.describe('Backup and Restore', () => {
    ...
    test('should create new backup', async ({ page }) => {
      ...
      await page.fill('[data-testid="backup-description-input"]', 'Backup before system update');
      
      await page.click('[data-testid="start-backup-button"]');
      
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Backup started successfully');
    });
    ...
    test('should restore from backup', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Restore started successfully');
    });
    ...
    test('should delete backup', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="success-message"]')).toContainText('Backup deleted successfully');
    });
  ...
  test.describe('Accessibility Tests', () => {
    ...
    test('should have proper ARIA labels', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="admin-dashboard"]')).toHaveAttribute('aria-label');
      await expect(page.locator('[data-testid="system-overview"]')).toHaveAttribute('aria-label');
    });
    ...
    test('should announce system updates to screen readers', async ({ page }) => {
      await page.goto('/admin');
      
      await page.click('[data-testid="refresh-data-button"]');
      
      const announcementElement = page.locator('[data-testid="system-update-announcement"]');
